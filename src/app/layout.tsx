  ...
  return (
    <html lang="th" className="selection:bg-accent/30">
      <body className="min-h-screen bg-background antialiased font-thai flex justify-center">
        <LanguageProvider>
          <div className="flex flex-col min-h-screen w-full max-w-[375px] bg-surface relative shadow-xl overflow-x-hidden">
            
            {/* Main workspace */}
            <div className="flex-1 flex flex-col pb-16 min-h-screen w-full">
              {/* Top Header */}
              <Bar />
